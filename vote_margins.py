import pandas as pd
elections = pd.concat([pd.read_csv("old_stuff/1976-2018-house2.csv", encoding= 'unicode_escape'), pd.read_csv("old_stuff/1976-2018-senate.csv", encoding= 'unicode_escape')])
